        ...
        window.addEventListener('touchstart', (e) => {
            for (let i = 0; i < e.changedTouches.length; i++) {
                ...
                // 如果點擊在右側按鈕區域，交給按鈕的 HTML onclick 處理，不干擾視角與搖桿
        ...
        function animate() {
            ...
            if (finalMove.length() > 0) {
                ...
                // 【方向修正關鍵】：
                // 由於 Three.js 的預設模型正面是朝向 負Z 軸，計算旋轉弧度時必須與移動向量完美契合。
                // 這裡使用 Math.atan2(finalMove.x, finalMove.z) 並且直接賦值給 rotation.y
                // 這能確保眼睛方塊（正面）完美直視移動前方的路，突進時也是百分之百往正面衝！
